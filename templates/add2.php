  <main>
    ...
    <form class="form form--add-lot container form--invalid" action="add2.php" method="POST" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>">
          ...
          <select id="category" name="category">
            ...
            <option value="<?= $category['id']; ?>" <?php if ($category['id'] == getPostVal('category_id')): ?>selected<?php endif; ?>><?= $category['category']; ?></option>
            <?php endforeach; ?>
          </select>
      ...
      <div class="form__item form__item--wide <?= $classname; ?>">
        ...
        <textarea id="lot_description" name="lot_description" placeholder="Напишите описание лота"><?= getPostVal('lot_description'); ?></textarea>
        <span class="form__error"><?= $errors['title']; ?></span>
      </div>
